...
public class ChessBoard extends Pane {
	...
	public ChessBoard(StatusBar newStatusBar) {
		...
		statusBar.Blackscore.setText("Black Score");
		statusBar.whitescore.setText("White Score");
	...
	public void movePiece(final double x, final double y){
		...
		{
			statusBar.whitescore.setText("Whitescore");
