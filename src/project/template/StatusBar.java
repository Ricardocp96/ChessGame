...
public class StatusBar extends HBox{
	...
	public StatusBar(){
		...
		whitepscore = new TextField();
		blackPlayerAlert = new Label("");
		Blackscore = new Label("");
		Blacpscore = new TextField();
...
//	    statusBarGp.setGridLinesVisible(true);
		...
		column.setPercentWidth(30);
		statusBarGp.getColumnConstraints().add(column);
		statusBarGp.setPrefSize(2000, 150);
		...
		statusBarGp.addRow(1, whitePlayerTimer, winner,Blacpscore, blackPlayerTimer);
	...
	private TextField whitepscore;
	private TextField Blacpscore;
